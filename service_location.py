...
def argParser():
    ...
    parser.add_argument('-s', action='store', type=int, dest='serviceID', default=1, help='The service id for the bus service you would like to capture the data for. Default: %(default)s')
